        ...
        for (Media media : store.getItemsInStore()) {
            try {
                ...
                if (fxmlLoader.getLocation() == null) {
                    System.err.println("Could not find FXML file: " + ITEM_FXML_FILE_PATH);
                    continue;
                }
                ...
                System.err.println("Error loading FXML for media: " + media.getTitle());
                e.printStackTrace();
            } catch (Exception e) {
                System.err.println("Unexpected error while loading media: " + media.getTitle());
                e.printStackTrace();
            }
        }
    }
